...
ORi.define(function (a, b) {
...
}), ORi.define("next.host.urls", function () {
    "use strict";
    var a = "default",
        b = "634c8a73",
        c = {
    ...
    return ORi.each(i, function (a, b) {
        e[b] = function (b, c, d) {
            var e = this._listeners || (this._listeners = {}),
                f = b._listenerId || (b._listenerId = ORi.getUid("l"));
    ...
    e(a, "message", function (a) {
        ...
        ORi.trigger("window.hashchange", {
            hash: a.location.hash
        })
    }, !1), e(a, "resize", h(function () {
        ORi.trigger("window.resize")
    }, 250, 50), !1);
    var n = function () {
        ORi.trigger("window.scroll")
    };
    e(a, "scroll", h(n, 250, 50)), e(i, "click", function () {
        ORi.trigger("window.click")
    });
    var o = function (a) {
        a = a || {}, this.state = o.INIT, this.uid = a.uid || ORi.getUid(), this.origin = a.origin, this.host = d(this.origin), this.target = a.target, this.window = null, j[this.uid] = this, this.on("ready", function () {
            this.state = o.READY
    ...
    ORi.extend(o, {
        ...
        READY: 1,
        KILLED: 2
    }), ORi.extend(o.prototype, ORi.Events), o.prototype.sendMessage = function (a, b) {
        var c = k.stringify({
                scope: "client",
                name: a,
                data: b
    ...
    ORi.extend(p.prototype, o.prototype), p.prototype.load = function () {
    ...
    var q = function (a) {
        o.call(this, a), this.styles = a.styles || {}, this.tabIndex = a.tabIndex || 0, this.title = a.title || "Ori", this.container = a.container, this.elem = null
    };
    ORi.extend(q.prototype, o.prototype), q.prototype.load = function () {
        var a = this.elem = i.createElement("iframe");
        a.setAttribute("id", "dsq-" + this.uid), a.setAttribute("data-ori-uid", this.uid), a.setAttribute("allowTransparency", "true"), a.setAttribute("frameBorder", "0"), this.role && a.setAttribute("role", this.role), a.setAttribute("tabindex", this.tabIndex), a.setAttribute("title", this.title), this.setInlineStyle(this.styles)
    }, q.prototype.getOffset = function (a) {
        return c(this.elem, a)
    }, q.prototype.setInlineStyle = function (a, b) {
        var c = {};
        ORi.isString(a) ? c[a] = b : c = a;
        var d = this.elem.style;
        return "setProperty" in d ? void ORi.each(c, function (a, b) {
            d.setProperty(b, "" + a, "important")
        }) : this._setInlineStyleCompat(c)
    }, q.prototype._setInlineStyleCompat = function (a) {
        this._stylesCache = this._stylesCache || {}, ORi.extend(this._stylesCache, a);
        var b = [];
        ORi.each(this._stylesCache, function (a, c) {
    ...
    var r = function (a) {
        var b = this;
        b.window = null, q.call(b, a), b.styles = ORi.extend({
            width: "100%",
            border: "none",
            overflow: "hidden",
            height: "0"
    ...
    ORi.extend(r.prototype, q.prototype), r.prototype.load = function (a) {
        var c = this;
        ...
        var f = ORi.isString(this.container) ? b(this.container) : this.container;
        f.appendChild(d)
    }, r.prototype.destroy = function () {
        return this.window = null, q.prototype.destroy.call(this)
    };
    var s = function (a) {
        q.call(this, a), this.contents = a.contents || "", this.styles = ORi.extend({
            width: "100%",
            border: "none",
            overflow: "hidden"
        }, a.styles || {})
    };
    ORi.extend(s.prototype, q.prototype), s.prototype.load = function () {
        q.prototype.load.call(this);
        var a = this.elem;
        a.setAttribute("scrolling", "no");
        var c = ORi.isString(this.container) ? b(this.container) : this.container;
...
}), ORi.define("JSON", function (a) {
    "use strict";
    var b, c = new ORi.Sandbox({
        container: "ori_thread",
        styles: {
            display: "none"
        }
    });
...
}), ORi.define("next.host.utils", function (a, b) {
    "use strict";
    ...
    function d(a) {
        ...
        for (var b, c = [/(https?:)?\/\/(www\.)?ori\.com\/forums\/([\w_\-]+)/i, /(https?:)?\/\/(www\.)?([\w_\-]+)\.ori\.com/i, /(https?:)?\/\/(www\.)?dev\.ori\.org\/forums\/([\w_\-]+)/i, /(https?:)?\/\/(www\.)?([\w_\-]+)\.dev\.ori\.org/i], d = c.length, e = 0; d > e; e++)
    ...
    function l(a, b, c, d) {
        ORi.isString(b) && (b = w.createElement(b));
        var e = null;
    ...
    var w = a.document,
        x = function () {
            ...
            return {
                ...
                listen: function (a) {
                    return ORi.addEvent(w, b, a)
                },
                stopListening: function (a) {
                    return ORi.removeEvent(w, b, a)
                }
            }
        }();
    return {
...
}), ORi.define("next.host.app", function (a) {
    "use strict";
    var b = ORi.isOwn,
        c = ORi.extend,
        d = ORi.use("next.host"),
        ...
        i = function (a) {
            ...
            this.uid = ORi.getUid(), b.register && b.register(this), this.settings = a || {};
            var c = [],
                d = this;
    ...
    c(i.prototype, ORi.Events), i.prototype.destroy = function () {
    ...
    var j = i.extend({
        ...
        getFrame: function () {
            ...
            return b.windowName ? c.windowName = b.windowName : c.container = this.settings.container || document.body, this.getFrameSettings && (c = this.getFrameSettings(c)), new(a = c.windowName ? ORi.Popup : ORi.Channel)(c)
        },
        setState: function (a) {
            var b = this.constructor;
    ...
    var k = j.extend({
            ...
            listenToScrollEvent: function (a) {
                ...
                if (c === f) return b.listenTo(ORi, "window.scroll", a),
                    function () {
                        b.stopListening(ORi, "window.scroll", a)
                    };
                var d = ORi.throttle(function () {
                    a.call(b)
                }, 250, 50);
                return ORi.addEvent(c, "scroll", d),
                    function () {
                        ORi.removeEvent(c, "scroll", d)
                    }
            },
            ...
            events: {
                beforeInit: function () {
                    this.settings.unsupported || (this.settings.windowName || (this.listenToScrollEvent(this.communicateViewportAndScrollStatus), this.listenTo(ORi, "window.resize", this.communicateViewportAndScrollStatus)), this.timestamp = +new Date)
                },
                afterInit: function () {
...
}), ORi.define("next.host.backplane", function () {
    "use strict";
    var a;
    try {
        localStorage.setItem("ori.localStorageTest", "ori"), localStorage.removeItem("ori.localStorageTest"), a = !0
    } catch (b) {
        a = !1
    }
    var c = function (b) {
        ...
        d = "ori.backplane.channel",
        e = "ori.backplane.messageUrl";
    return ORi.extend(c.prototype, {
        frameEvents: {
            invalidate: "clearCredentials"
        },
        initialize: function () {
            var a = this;
            ORi.each(this.frameEvents, function (b, c) {
...
}), ORi.define("next.host.lounge", function (a) {
    "use strict";
    var b = a.document,
        ...
        h = g.extend({
                ...
                "frame:indicator:init": function (a, b) {
                    if (b.getOffset) {
                        for (var c, d, e = ["north", "south"], g = this.indicators, h = b.getOffset().width + "px", i = {
                            ...
                            d = e[k], c = new ORi.Sandbox({
                                uid: "indicator-" + d,
                                container: this.settings.container,
                                contents: a[d].contents,
                                styles: ORi.extend(j[d], i),
                                role: "alert",
                                type: d
                            });
                            try {
                ...
                "frame:viglink:init": function (b, c) {
                    ...
                    if (!(a.vglnk_self || a.vglnk || d())) {
                        var e = b.apiUrl,
                            f = b.key,
                            g = String(b.id);
                        null != b.clientUrl && null != e && null != f && null != b.id && (this.listenForAffiliationRequests(e, f, g), ORi.define("vglnk", function () {
                            return {
                                api_url: e,
                                key: f,
                                sub_id: g,
                                onlibready: function () {
                                    c.sendMessage("viglink:change:timeout", {
                                        timeout: ORi.vglnk.opt("click_timeout")
                                    })
                                }
                            }
                        }), a.vglnk_self = "ORi.vglnk", ORi.require(b.clientUrl))
                    }
                },
                "frame:loadBackplane": function (a, b) {
                    this.backplane = new ORi.next.host.backplane.BackplaneIntegration(b)
                }
            },
            ...
            onBeforePostCreate: function (a) {
                ...
                try {
                    ...
                    ORi.log("Error processing Ori callback: ", e.toString())
                } finally {
            ...
            forwardGlobalEvents: function () {
                var a = this;
                a.settings.windowName || (a.listenTo(ORi, "window.resize", function () {
                    a.frame.sendMessage("window.resize")
                }), a.listenTo(ORi, "window.click", function () {
                    a.frame.sendMessage("window.click")
                })), a.listenTo(ORi, "window.hashchange", function (b) {
            ...
            bindPublisherCallbacks: function () {
                var a = this,
                    ...
                    d = b.callbacks;
                d && ORi.each(d, function (b, d) {
                    c[d] && ORi.each(b, function (b) {
                        a.on(c[d], b)
                    })
                })
            },
            isContainerVisible: function () {
                var a = this.getViewportCoords(),
                    b = ORi.getOffset(this.settings.container, this.getScrollContainer()),
            ...
            showSlowLoadingMessage: function () {
                ...
                if (b.loadingElem) {
                    ...
                    b.triggeredSlowEvent = !0, f.logStat(b.state === b.constructor.states.READY ? "slow_embed.got_ready" : b.state === b.constructor.states.LOADED ? "slow_embed.loaded" : "slow_embed.no_ready"), b.loadingElem.firstChild.insertAdjacentHTML("afterend", '<p align="center">Ori seems to be taking longer than usual. <a href="#" onclick="ORi.reset({reload: true}); return false;">Reload</a>?</p>')
                }
            },
            ...
            addLoadingAnim: function () {
                ...
                if (!(h.state >= h.constructor.states.RUNNING)) {
                    ...
                    var m = g.style;
                    return m.height = m.width = "29px", m.margin = "11px 14px", g.className = "ori-loader", m.backgroundImage = /*l.backgroundImage = */"url(" + d + ")", m.backgroundRepeat = l.backgroundRepeat = "no-repeat", m.backgroundPosition = "-54px 0", "dark" === h.settings.colorScheme && (l.backgroundPosition = "0 -51px", m.backgroundPosition = "-54px -51px"), m.transformOrigin = "50% 50% 0px", i.appendChild(a), h.loadingElem = a, h.setSlowLoadingMessageTimer(15e3), h.loadingElem
                }
            },
...
}), ORi.define("next.host.config", function (a, b) {
    "use strict";
    var c = ORi.use("next.host.utils"),
        d = function (a, c) {
    ...
    d.ORI_GLOBALS = ["apikey", "owner", "ownerName", "ownerPhoto", "url", "title", "category_id", "slug"];
    var e = d.prototype;
    return e.getContainer = function () {
        var a = this.win;
        return a.document.getElementById(a.ori_container_id || "ori_thread")
    }, e.runConfigurator = function () {
        var a = this.configurator || this.win.ori_config;
        ...
        var a, b = this.win,
            e = this.config,
            f = e.page;
        ORi.each(d.ORI_GLOBALS, function (a) {
            var c = b["ori_" + a];
            "undefined" != typeof c && (f[a] = c)
        }), this.runConfigurator(), e.api_key || (a = f.apikey, e.api_key = a ? a.toLowerCase() : c.getApiKey(b.document))
    }, e.getValuesFromAttributes = function (a) {
        var b = this.config,
            c = b.page;
        [].forEach.call(a.attributes, function(d) {
            if (/^data-ori-/.test(d.name)) {
                var camelCaseName = d.name.substr(9).replace(/-(.)/g, function ($0, $1) {
        ...
        var a = this.win,
            ...
            d = b.page,
            e = this.getContainer();
        return this.getValuesFromGlobals(), this.getValuesFromAttributes(e), {
            container: e,
            forum: b.forum,
            sortOrder: b.experiment.sort_order || "desc",
...
}), ORi.define("next.host.loader", function (a) {
    "use strict";
    var b, c = ORi.use("next.host.loader"),
        d = ORi.use("next.host"),
        ...
        g = function () {
            ...
            if (b.getElementsByClassName) {
                if ("complete" !== b.readyState) return ORi.addEvent(a, "load", g);
        ...
        h = function (a) {
            if (b) return i({
                reload: !0
            }), ORi.log("Use ORi.reset instead of reloading embed.js please.");
            e.configurator = a;
            var g = e.toJSON();
            return f || (g.container.innerHTML = "", f = !0), b = d.lounge.Lounge(g), b.init(), c.removeOriLink(), b
        },
        i = function (a) {
...
function () {
    "use strict";
    ORi.reset = ORi.next.host.loader.reset, ORi.request = {
        get: function (a, b, c) {
            ORi.require(a, b, c)
        }
    }
}(), ORi.next.host.loader.loadEmbed();